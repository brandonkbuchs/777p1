...
var basemap = L.tileLayer('https://api.mapbox.com/styles/v1/{username}/{style}/tiles/256/{z}/{x}/{y}@2x?access_token={accessToken}', {
    attribution: 'Baselayer provided through mapbox studio',
    username: 'brandonkbuchs', //basemap user name
    style: 'ck6nwlzhg2h1w1io0wbapg5el', //Style
    accessToken: 'pk.eyJ1IjoiYnJhbmRvbmtidWNocyIsImEiOiJjamNiOWN5Z2EwMDF2MnF1ajh3NHNwZmN3In0.ZpBtYtaL-UhFvXEHn3vUWA' //Accesstoken
});
